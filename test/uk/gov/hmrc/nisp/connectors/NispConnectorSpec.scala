...
class NispConnectorSpec extends UnitSpec with MockitoSugar with  BeforeAndAfter with OneAppPerSuite {
  ...
  def niResponse:NIResponse = NIResponse(Some(NIRecord(List(
    NIRecordTaxYear(1976,true,0,0,0,52,None,None,false, false), NIRecordTaxYear(1977,true,0,0,0,52,None,None,false, false), NIRecordTaxYear(1978,true,325,0,0,0,None,None,false, false),
    NIRecordTaxYear(1979,true,390,0,0,0,None,None,false, false), NIRecordTaxYear(1980,true,472.5,0,0,0,None,None,false, false), NIRecordTaxYear(1981,true,620,0,0,0,None,None,false, false), NIRecordTaxYear(1982,true,787.5,0,0,0,None,None,false, false),
    NIRecordTaxYear(1983,true,900,0,0,0,None,None,false, false), NIRecordTaxYear(1984,true,1333.8,0,0,0,None,None,false, false), NIRecordTaxYear(1985,false,0,0,0,0,None,None,false, false), NIRecordTaxYear(1986,true,0,0,0,52,None,None,false, false),
    NIRecordTaxYear(1987,false,0,0,0,0,None,None,false, false), NIRecordTaxYear(1988,false,0,0,0,0,None,None,false, false), NIRecordTaxYear(1989,true,0,0,0,52,None,None,false, false), NIRecordTaxYear(1990,true,0,0,0,52,None,None,false, false),
    NIRecordTaxYear(1991,false,20.69,0,0,0,None,None,false, false), NIRecordTaxYear(1992,false,8.28,0,0,2,None,None,false, false), NIRecordTaxYear(1993,true,447.91,0,0,0,None,None,false, false), NIRecordTaxYear(1994,true,938.61,0,0,0,None,None,false, false),
    NIRecordTaxYear(1995,true,1046.32,0,0,0,None,None,false, false), NIRecordTaxYear(1996,true,1147.98,0,0,0,None,None,false, false), NIRecordTaxYear(1997,true,1296.18,0,0,0,None,None,false, false), NIRecordTaxYear(1998,true,1565.76,0,0,0,None,None,false, false),
    NIRecordTaxYear(1999,true,1763.98,0,0,0,None,None,false, false), NIRecordTaxYear(2000,true,1913.39,0,0,0,None,None,false, false), NIRecordTaxYear(2001,true,2011.61,0,0,0,None,None,false, false), NIRecordTaxYear(2002,true,2166.7,0,0,0,None,None,false, false),
    NIRecordTaxYear(2003,true,2484.49,0,0,0,None,None,false, false), NIRecordTaxYear(2004,true,2573.95,0,0,0,None,None,false, false), NIRecordTaxYear(2005,true,2495.74,0,0,0,None,None,false, false), NIRecordTaxYear(2006,false,0,0,0,0,None,None,false, false),
    NIRecordTaxYear(2007,true,3312,0,0,0,None,None,false, false), NIRecordTaxYear(2008,true,2699.4,0,0,0,None,None,false, false), NIRecordTaxYear(2009,true,4259.6,0,0,0,None,None,false, false), NIRecordTaxYear(2010,false,0,0,0,0,Some(626.6),Some(NpsDate(new LocalDate(2019,4,5))),true, false),
    NIRecordTaxYear(2011,false,0,0,0,0,Some(655.2),Some(NpsDate(new LocalDate(2019,4,5))),true, false), NIRecordTaxYear(2012,false,0,0,0,0,Some(689.0),Some(NpsDate(new LocalDate(2019,4,5))),true, false), NIRecordTaxYear(2013,false,0,0,0,0,Some(704.6),Some(NpsDate(new LocalDate(2019,4,5))),true, false)
