    ...
    "the user is a MQP" when {
      ...
      "The scenario is No years to contribute" when {
        ...
        "State Pension page with MQP: No Gaps || Cant get pension" should {
          ...
          "render page 'You usually need at least 10 qualifying years on your National Insurance record " +
            "at State Pension age to get any State Pension. You will not get these by 4 May 2017.' " in {
            mockSetup
            assertEqualsText(
              doc,
              "[data-spec='state_pension_mqp__p5']",
              "You usually need at least 10 qualifying years on your National Insurance record " +
                "at State Pension age to get any State Pension. You will not get these by 4 May 2017."
            )
          }
