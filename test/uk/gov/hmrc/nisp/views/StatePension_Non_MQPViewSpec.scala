...
class StatePension_Non_MQPViewSpec extends UnitSpec with MockitoSugar with HtmlSpec with BeforeAndAfter with OneAppPerSuite {
  ...
  "Render State Pension view with NON-MQP :  Continue Working || More than 10 years || no need to fill gaps || Full Rate and Personal Max: when some one has more years left" should {
  ...
  "Render State Pension view with NON-MQP :  Reached || More than 10 years || No Gapss || Full Rate and Personal Max" should {
  ...
  "Render State Pension view with NON-MQP :  Continue Working || More than 10 years || No Gapss || Full Rate & Personal Max" should {
