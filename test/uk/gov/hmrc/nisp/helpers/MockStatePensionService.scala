...
import uk.gov.hmrc.nisp.services.{NispConnection, StatePensionConnection, StatePensionService}

object MockStatePensionServiceViaNisp extends StatePensionService with NispConnection {
