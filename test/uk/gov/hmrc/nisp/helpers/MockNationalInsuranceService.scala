...
import uk.gov.hmrc.nisp.services.{NationalInsuranceConnection, NationalInsuranceService, NispConnectionNI}


object MockNationalInsuranceServiceViaNisp extends NationalInsuranceService with NispConnectionNI {
