...
class StatePensionExclusionSpec extends UnitSpec {
  ...
  "finalRelevantStartYear" when {
    ...
    "the pensionDate is 5th April 2020" should {
      "be 2018" in {
        StatePensionExclusion(
          ...
          Some(67),
          Some(LocalDate.of(2020, 4, 5))
        ).finalRelevantStartYear shouldBe Some(2018)
      }
    }
    ...
    "the pensionDate is 6th April 2020" should {
      "be 2019" in {
        StatePensionExclusion(
          List(Exclusion.AmountDissonance),
          Some(67),
          Some(LocalDate.of(2020, 4, 6))
        ).finalRelevantStartYear shouldBe Some(2019)
      }
    }
    ...
    "the pensionDate is 6th April 2000" should {
      "be 1999" in {
        StatePensionExclusion(
          List(Exclusion.AmountDissonance, Exclusion.PostStatePensionAge),
          Some(65),
          Some(LocalDate.of(2000, 4, 6))
        ).finalRelevantStartYear shouldBe Some(1999)
      }
    }
