  ...
  implicit val hc = HeaderCarrier()
   ...
   "QuestionnaireEvent" should {
     ...
     "not store the email address if research is No" in {
       val event = new QuestionnaireEvent(None, None, None, None, None, None, Some(1), Some("test@test.com"), "Name", "NINO", "", None)
       event.detail("email") shouldBe "N/A"
     }

     "not store the email address if research is Blank" in {
       val event = new QuestionnaireEvent(None, None, None, None, None, None, None, Some("test@test.com"), "Name", "NINO", "", None)
       event.detail("email") shouldBe "N/A"
     }

     "store the email address if research is Yes" in {
       val event = new QuestionnaireEvent(None, None, None, None, None, None, Some(0), Some("test@test.com"), "Name", "NINO", "", None)
